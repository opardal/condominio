...
urlpatterns = [
    ...
    path('<competencia>/despesas/<int:pk>/update/', views.DespesaUpdate.as_view(), name='despesa-update-comp'),
    path('<competencia>/despesas/<int:pk>/delete/', views.DespesaDelete.as_view(), name='despesa-delete-comp'),
